...
import gamealgorithms.game.GameState;
...
public class GamePanel extends JPanel {
    ...
    private void drawGameOver(Graphics2D g, int score) {
        ...
        drawC(g, "Environmental Contribution Score  " + String.format("%06d", score), cx, cy + 26);

        g.setFont(F_BODY);
        g.setColor(new Color(160, 175, 215));
        drawC(g, "Carbon Imprint  :" + String.format("%.5f", Player.GetCarbonImprint())+"g of carbon dioxide equivalent", cx, cy + 46);
